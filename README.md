...
- **For Technical Writer roles** → start with one of the following:
  - [`tech-writing/`](https://github.com/interstellardrumbeat/tech-writing) - Documentation samples for technical products, focused on clarity, structure, and user-centered writing.
...
- **For broader context** (writing style, general communication skills, content creation and science communication) → see the [links](#-external-links--contacts) to my Substack profile and website.
